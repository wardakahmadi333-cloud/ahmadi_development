document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ===============AHMADI DEVELOPMENT Multilingual Portfolio System English / Pashto / Dari=============== */
    ...
    const seoTranslations = {
        ...
        en: {
            title:
                "Ahmadullah Ahmadi | Web Developer | Full Stack Web Development",
        ...
        ps: {
            title:
                "احمدالله احمدي | ویب ډیولپر | Full Stack Web Development",
        ...
        fa: {
            title:
                "احمدالله احمدی | توسعه‌دهنده وب | Full Stack Web Development",
    ...
    function updateThemeIcons() {
        ...
        if (githubIcon) {
            ...
            githubIcon.src =
                isDark
                    ? "./asset/image/github-light.png"
                    : "./asset/image/github-dark.png";
        }
    }
    ...
    function createMobileMenu() {
        ...
        mobileMenu.className =
            "sm:hidden hidden absolute top-full left-0 right-0 bg-slate-900 border-t w-1/2 border-slate-700 p-4 z-50";
        ...
        languageLabel.dataset.translationKey =
            "Language";
    ...
    function changeLanguage(language) {
        ...
        /*
         * Reloading the page ensures that
         * translation always starts from
         * the original English HTML.
         */
